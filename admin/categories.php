...
<title>Categories < VikkyCMS Admin</title>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i>Categories</li>
      </ol>
    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php
                                    ...
                                    if($show=="edit")
                                    {
                                        include 'pages/categories/cat_edit.php';
                                    }else{
                                        include 'pages/categories/cat_list.php';
                                    }
